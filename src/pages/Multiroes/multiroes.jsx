          ...
          <div className={styles.sectionContent}>
            ...
            <div className={styles.eventsGridLayout}>
              <div className={styles.eventModernCard} >
                ...
                <div className={styles.eventHeaderDate}><span className={styles.day}>12</span><span className={styles.month}>Jul</span></div>
              ...
              <div className={styles.eventModernCard}  id="inscricao">
                <div className={`${styles.eventBadge} ${styles.open}`}>Inscrições Abertas</div>
                <div className={styles.eventHeaderDate}><span className={styles.day}>26</span><span className={styles.month}>Jul</span></div>
                <div className={styles.eventBodyInfo}>
              ...
              <div className={styles.eventModernCard}>
                ...
                <div className={`${styles.eventHeaderDate} ${styles.textAlert}`}><span className={styles.day}>09</span><span className={styles.month}>Ago</span></div>
                <div className={styles.eventBodyInfo}>
